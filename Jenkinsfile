...
def upstreamProjects = [
  ...
  'taglib', // <groupId>com.semanticcms</groupId><artifactId>semanticcms-section-taglib</artifactId>

  // Runtime Direct
  'renderer-html', // <groupId>com.semanticcms</groupId><artifactId>semanticcms-section-renderer-html</artifactId>
  'style', // <groupId>com.semanticcms</groupId><artifactId>semanticcms-section-style</artifactId>
