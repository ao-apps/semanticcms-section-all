...
[![Build](https://github.com/ao-apps/semanticcms-section-all/actions/workflows/build.yml/badge.svg?branch=1.x)](https://github.com/ao-apps/semanticcms-section-all/actions?query=workflow%3ABuild)
